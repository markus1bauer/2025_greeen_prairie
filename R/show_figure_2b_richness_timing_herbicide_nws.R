...
### * Model ####
load(file = here("outputs", "models", "model_richness_timing_herbicide_nws_1.Rdata"))
m <- m1
formula(m)
...
data <- sites %>%
  rename(predicted = y, x = treatment, facet = site)
...
### Save ###
ggsave(
  here("outputs", "figures", "figure_2b_300dpi_7x4cm.tiff"),

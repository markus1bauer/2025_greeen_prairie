---
title: "GREEEN tallgrass prairie restoration: Seeded richness ~ Species pool size (SW Station)"
author: "MB"
...
load(file = here("outputs", "models", "model_richness_pool_sws_3.Rdata"))
m_1 <- m2
m_2 <- m3
```
...
plotResiduals(simulation_output_1$scaledResiduals, factor(sites$seeded_pool))

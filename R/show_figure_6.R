...
### Save ###
ggsave(
  here("outputs", "figures", "figure_6_i_300dpi_16x11cm.tiff"),
...
graph_b <- ggplot() +
  ...
  ### Save ###
  ggsave(
    here("outputs", "figures", "figure_6_ii_300dpi_8x10cm.tiff"),
...
### Save ###
ggsave(
  here("outputs", "figures", "figure_6_300dpi_16x21cm.tiff"),

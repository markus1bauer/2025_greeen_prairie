...
# Show figure ####
# RLQ ~ pool * seeding timing/herbicide (NW Station)
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Markus Bauer
# 2025-10-23
...
### * Model ####
model <- read_csv(
  here("outputs", "models", "model_rlq_pool_nw_station.csv"),
  col_names = TRUE, na = c("na", "NA", ""), col_types = cols(
    .default = "?",
    type = "f"
  )
...
centroid <- data %>%
  filter(type == "sites", !(treatment == "spring_0_33" & year == "2016")) %>%
...
### Save ###
ggsave(
  here("outputs", "figures", "figure_4c_300dpi_8x8cm_centroid.tiff"),

...
# ggsave(
#   "figure_a1_map_ecoregions_300dpi_12x15cm.tiff",
...
graph_sites <- ggplot() +
  ...
  annotate(
    geom = "text", label = c("Mississippi", "Grand River", "Lake Michigan"),
    x = c(-91.1, -84.6, -87), y = c(44.4, 43.3, 43.9), angle = c(304, 350, 80),
    color = "blue", size = 2.5
  ) +
  geom_sf(data = sites, colour = "black", size = 1) +
  annotate(
    geom = "label", label = c("NW Station", "Lux Arbor", "SW Station"),
    x = c(-83.4, -83.5, -84.1), y = c(44.9, 42.5, 41.7),
...
ggsave(
  "figure_a1_map_elevation_300dpi_15x9cm.tiff",

---
title: "GREEEN tallgrass prairie restoration: Seeded richness ~ Seeding time * Herbicide pre-treatment (Lux Arbor)"
author: "MB"
...
load(file = here("outputs", "models", "model_richness_timing_herbicide_lux_2.Rdata"))
m_1 <- m1
m_2 <- m2
```
